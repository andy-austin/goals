          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                <div>
                  <div className="text-sm text-muted-foreground">{t('details.targetAmount')}</div>
                  <div className="text-lg font-semibold text-foreground">
                    {formatCurrency(selectedGoal.amount, selectedGoal.currency, locale)}
                  </div>
                </div>
                <div>
              ...
              {selectedGoal.whyItMatters && (
                <div className="pt-2 border-t border-border">
                  <div className="text-sm text-muted-foreground mb-1">{t('details.whyItMatters')}</div>
