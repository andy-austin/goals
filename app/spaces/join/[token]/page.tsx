...
const CheckCircleIcon = () => (
  <svg className="w-16 h-16 text-success" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const ClockIcon = () => (
  <svg className="w-16 h-16 text-warning" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
